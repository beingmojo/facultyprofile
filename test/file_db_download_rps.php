...
<html>
    ...
    <body>
        <!--Download file from MySQL:
            ...
            The url would look like: file_db_download_rps2.php?idcv=3
        -->
        <?php
        ...
        /*When you click the download link, the $_GET['id'] will be set. We
          ...
          MySQL Database: */
        $query = "SELECT pid FROM txst_fac_profl";
...
//            echo "<br />File $fileName uploaded successfully<br />";
        ...
        if(mysql_num_rows($result) == 0) {
            ...
            while(list($id) = mysql_fetch_array($result)) {
                print("<a href=\"file_db_download_rps2cv.php?idcv=" . $id ."\">".
                                "cv</a>");
                print("&nbsp;&nbsp;&nbsp;&nbsp;");
                print("<a href=\"file_db_download_rps2pubc.php?idpubc=" . $id ."\">".
                                "pubc</a> <br />");
            }
        }
