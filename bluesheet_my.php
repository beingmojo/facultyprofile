            ...
            <table width="100%">
                <tr>
                    <td>
                        ...
                        &nbsp;&nbsp;
                        <a href='f_login.php?view=2' style="text-decoration:none"><span class="details">(Account Info </span></a>
                                    ...
                                    <table width="100%">
                                        <tr>
                                            ...
                                            <td width="300" align="right">
                                                ...
                                                if (no_rec > 15) echo "<span style=font-weight:bold;>Page</span>";
...
<?php
                                                ...
                                                if ($sort_view == 'name') $sort_view = 'bs_name';
                                                ...
                                                if ((mysql_num_rows($results) > 0) && ($pid != 0)) {
                                                    while ($rows = mysql_fetch_array($results)) {
                                                        ...
                                                        if ($rows["bs_status"] != "Saved") {
                                                            ...
                                                            if (mysql_num_rows($results_1) > 0) {
                                                                ...
                                                                while ($rows_1 = mysql_fetch_array($results_1)) {
                                                                    if ($rows_1["status"] == "Approved") $approve_count++;
                                                                    else if ($rows_1["status"] == "Denied") $deny_count++;
                                                                    else if ($rows_1["status"] == "Pending") $pending_count++;
                                                                }
                                                            }
                                                            if ($rows["bs_status"] != "Submitted") {
                                                                ...
                                                                echo $rows["bs_status"] . " - <span style=font-size:8pt;>Pending on OSP to route</span></td>";
                                                            }
                                                        }else {
                                                            echo $rows["bs_status"];
                                                            if ($rows["ret_by"] == "") echo "</td>";
                                                            else echo " - <span style=font-size:8pt;>Returned By " . $rows["ret_by"] . "</span></td>";
                                                        }
                                                        ...
                                                        if ($rows["bs_status"] == "Saved") {
                                                            if ($rows["ret_comments"] != "") echo "<u>Comments</u>: " . $rows["ret_comments"] . "<br>";
                                                        }
                                                        echo "</td></tr>";
                                                    }
                                                }
