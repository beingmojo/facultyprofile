...
$_POST['page-title'] = "Create New Research Center Profile";
        ...
        <td colspan="2">
            ...
            <script type="text/javascript" language="javascript">
                function validatefields()
                {
                    if( document.frmNewProfile.ctr_general_info_login_id != null )
                    {
                        ...
                        {
                            //changed...........................................
                            document.frmNewProfile.ctr_general_info_login_id.value =
                                document.frmNewProfile.ctr_general_info_login_name.value;
            ...
            <form action="createnew.php" method="post" name="frmNewProfile" enctype='multipart/form-data' onSubmit='return validatefields()'>
                ...
                if (real_check_user_groupid($db_conn, "admin") == true) {
                    ...
                    //changed, readonly removed, find removed
                    print( "<td>&nbsp;<input class='form_elements_edit' type='text' id='ctr_general_info_login_name' name='ctr_general_info_login_name' size='30' maxlength='255' value=''> ");
                ...
                print( "<tr>");
                print( "<td>&nbsp;<span class='form_elements_text'><B>Center Name</B></span></td>");
                print( "<td>&nbsp;<input class='form_elements_text' type='text' " .
                    "name='ctr_general_info_name' size='100' maxlength='255'> </td>");
                print( "</tr>");

                print( "<tr>");
                print( "<td>&nbsp;<span class='form_elements_text'><B>Center Description</B></span></td>");
