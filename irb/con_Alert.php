...
if (($info['numContinued']) !=2){
		...
		//echo "Approval date: ".$actionRequestDate. "   Expiration date: ". $exprationDate."; Alert time 1: ".$alterTime. "Alert time 2: ".$alterTime2."<br>";
			...
			$body ="Your IRB application is going to expire. The application number is: ". $info['App_Number']. ". If you need to request for continuation, please log into the IRB Online Application Management System at: http://www.osp.txstate.edu/irb/. You will not be able to apply for continuation after ".$exprationDate.".";	
