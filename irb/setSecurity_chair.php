...
if (isset($_POST['submit'])) { // if form has been submitted
	...
	{
		mysql_query("UPDATE security SET SecurityCode = '".$_POST['irbCode']."' WHERE ID = 'osp_irb'"); 

	}

}

$query_Recordset1 = "SELECT * FROM security where ID='osp_irb'";
...
<tr><td colspan=2><h5 align="center" class="style46"><br>Set Security Code for IRB Chairs and Administrators to Register </h5></td></tr> 
 
<tr><td><div align="center">Old IRB Security Code:</div></td><td> 
<input type="text" name="dumy" value="<?php echo $row_Recordset1['SecurityCode'];?>" maxlength="50" disabled="disabled"> 
</td></tr> 
<tr><td><div align="center">New IRB Security Code:</div></td><td> 
