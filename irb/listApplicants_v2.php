...
<td width="209" class="style18"><label>
  <input name="button" type='button' onClick="deleteConfirm('<?php echo $row_Recordset1['username']?>')" value='Remove Applicant Permanently'>
</label></td>
</tr><tr><td class="style18" >User Name:</td><td class="style18">
    <span class="style16"><?php echo $row_Recordset1['username']; ?></span></td>
  <td class="style18"><form name="form1" method="post" action="">
    <label>
      <input type="button" name="button2" onClick="javascript:document.location.href='irb_listApp_byApp.php?username=<?php echo $row_Recordset1['username']?>'" value="Applications Submitted">
      </label>
  </form>
  </td>
</tr>
