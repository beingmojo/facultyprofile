...
<div align="center" class="style3">
  <p><br>
      <br>
    APPLICATION DATA</p></div>
  <p align="center"><a href="appSummary_irb_print.php?appNum=<?php echo $appNum;?>" target="_blank">Print Current Page </a></p>

</td></tr><TD><TABLE cellpadding="10"><tr><td>
  <span class="style48"><p>APPLICATION REFERENCE NUMBER: <font color = "red"><?php echo($appNum) ?></font></span>
