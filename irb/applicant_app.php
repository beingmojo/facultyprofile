...
$query_Recordset1 = "SELECT ActionFlag, application.App_Number, application.Status, application.ProjectTitle FROM application WHERE application.username='".$un_Recordset1."' ORDER BY submissionFinishedDate DESC";
...
<table width="800" height="300" border="0" align="center" bgcolor="#ffffff">
  <tr>
    <td colspan="4" bgcolor="#000000"><div align="center">
      <div align="center"><a class="irb" href="<?php echo $_SESSION['myhome'];?>">My IRB Home</a> <span class="style42">|</span><a class="irb" href="applicant_app.php"> IRB Applications Submitted</a> <span class="style42">|</span> <a class="irb" href="irbform.php" title="IRB Application">Start a New IRB Application</a> <span class="style42">|</span><a href="LogOut.php" class="irb"> Log
        Out</a></div></td>
  </tr>
  ...
  <tr><td colspan="5"><p class="style34">
      <div align="center"><span class="style36"> <b>IRB Applications Submitted</b> </span></div>
      <hr></td></tr>
  <td ></p>
  <p>
<?php
...
echo "<tr><td colspan='2' ><font color='red'>You have not submitted any IRB applications.</font></td></tr>";
  ...
  <tr>
  <td  colspan="4"><br><?php echo "<a href='statSummary_app.php?appNum=".$row_Recordset1['App_Number']."'>Application Status</a>"; ?>   |   
 <?php echo "<a href='appSummary_applicant.php?appNum=".$row_Recordset1['App_Number']."'>Review Application Data</a>"; ?>      
    <?php 
	...
	<?php 
if (($row_Recordset1['Status'] == "Application in Process") || ($row_Recordset1['Status'] == "IRB Admin Requests Revision") || ($row_Recordset1['Status'] == "IRB Chair Requests Revision"))
	echo "<a href='uploader.php?appNum=".$row_Recordset1['App_Number']."'>Upload Supporting Documents</a>";
	...
	echo "   |   <a href='continuation/irb_continuation_change_form.php?appNum=".$row_Recordset1['App_Number']."'>Apply for Continuation/Change</a>"; } else echo "";?>
