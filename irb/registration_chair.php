...
{
echo("You are not authorized to register as an IRB administrator or chair.");
exit;
}
else
{
      ...
      <tr>
		...
		<form name="mainform" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" onSubmit="return validate(this)">
            ...
            <div align="center">
                ...
                <tr>
                  <td> <div align="left">Please type in your IRB administrator security code:</div></td>
                    <td><input type="password" name="SecurityCode">                </td>
                  </tr>
                  <tr>
                    <td><span class="style7">
                      <div align="left">
                        <input type="hidden" name="User_Type" value="IRB Chair">
                        </div></td></tr>
                  <tr>
                    <td> <span class="style7">
