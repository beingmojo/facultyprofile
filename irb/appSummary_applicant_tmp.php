...
<p>&nbsp;</p>
  ...
  <h3>SECTION 1: </h3>
  <h5> APPLICATION REFERENCE NUMBER: <font color = "red"><?php echo($appNum); ?></font>  </h5>
 ...
 <b> <?php echo $rs_app['FunderName']; ?></b>
  ...
  <blockquote> 
    <p> Children under the age of 18: 
      <?php echo $rs_app['ChildrenUnder18']; ?>
    ...
    <?php echo $rs_app['IllnessInjoryOrDisability']; ?>
  ...
  <blockquote> 
    <p><font color="#FF0000">*</font> Is the language in the document appropriately 
      ...
      <?php echo $rs_app['AppropriateLanguage']; ?><br>
 ...
 <?php echo $rs_app['ArrangeForTranslators']; ?><br>
  ...
  <blockquote> 
    <p><font color="#FF0000">*</font> A statement that the study involves research? 
      ...
      <?php echo $rs_app['AlternativesOfDisclosure']; ?><br>
      <br>
