...
$query_Recordset1 = "SELECT ActionFlag, application.App_Number, application.ProjectTitle, application.Status, facultyCertified, application.ReviewerID, application.submissionFinishedDate,requestHSPActionDate, application.ReceivedDate, ChairReviewDate, application.ReviewDate, application.RevisionRequestDate, application.ApprovedDate, application.RevisionDate, application.rev1ID, application.rev2ID,application.rev3ID, application.rev1Comments, application.rev2Comments, application.rev3Comments, application.rev1Approved, application.rev2Approved, application.rev3Approved, application.rev1ApprovedDate, application.rev2ApprovedDate, application.rev3ApprovedDate, application.irbActionLog, application.revActionLog, application.appActionLog, application.irbEmails FROM application where App_Number = '".$_GET['appNum']."'";
...
<table width="800" height="300" border="0" align="center" bgcolor="#ffffff">
  <tr>
<td bgcolor="#000000"><div align="center"><a class="irb" href="<?php echo $_SESSION['myhome'];?>">My IRB Home</a> <span class="style42">|</span> <a class="irb" href="statSummary_faculty.php?appNum=<?php echo $row_Recordset1['App_Number']?>">Application Status</a> <span class="style42">|</span> <a class="irb" href="appSummary_faculty.php?appNum=<?php echo $row_Recordset1['App_Number'];?>">Review Application Data</a>
	
	<span class="style42">|</span>  <a href="LogOut.php" class="irb">Log Out</a>
