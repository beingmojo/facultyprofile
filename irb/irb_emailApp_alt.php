...
//*********************************************************
   ...
   $ActionFlag = "No";
  $insertSQL = sprintf("UPDATE application SET ActionFlag=%s,irbActionLog=%s, Status=%s, ApprovedDate=%s WHERE App_Number=%s", GetSQLValueString($ActionFlag, "text"), GetSQLValueString($newaction, "text"), GetSQLValueString($_POST['newstatus'], "text"), GetSQLValueString($today, "text"), GetSQLValueString($appNum, "text"));
...
IRB Admin Requests Revision </td>
	...
	<tr>
      <td class="style38"><input name="newstatus" id="newstatus" type="radio" value="IRB Admin Requests Applicant to Complete HSP Training" <?php if($row_Recordset1['Status']== "IRB Admin Requests Applicant to Complete HSP Training") echo "Checked";?> />
...
None of the Above</td>
	...
	<tr><td>
	         ...
	         <br>
	           ...
	           <input name="prev_msg" type="hidden" id="prev_msg" value="<?php echo $row_Recordset1['irbEmails']; ?>"><br>
	           <?php 
			
echo "<br><textarea cols='80' rows='10' name = 'xyz'>";
