...
$sql2 = "SELECT * FROM user where LastName='".$_POST['LastName']."'";
...
<tr><td colspan="3"><div align="center"><strong>TOTAL IRB APPLICATIONS (Total: <?php echo $totalRows_Recordset1;?>)</strong></div><BR>

   <tr>
     <td colspan="3"> <span class="body"><strong>Applicant Name </strong></span>: <?php echo $rs_User['FirstName']; ?>&nbsp;<?php echo $rs_User['LastName']; ?><br>The Applicant is: <?php echo $rs_User['User_Type']; ?>&nbsp;&nbsp;<strong>Department/Admin Office</strong>: <?php echo $rs_User['Department']; 
  ...
  { 
  ?>
<tr><td colspan="3"><hr><span class="style23"><strong>Application Title</strong>: 

 <?php echo $row_Recordset1['ProjectTitle']; ?></span></td></tr>
