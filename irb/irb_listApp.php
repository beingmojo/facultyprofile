...
$query_Recordset1 = "SELECT ActionFlag, submissionFinishedDate, application.App_Number, continuationID, application.ProjectTitle, application.Status, application.ReviewerID, application.ReceivedDate, requestHSPActionDate, application.ReviewDate, application.RevisionRequestDate, application.ApprovedDate, lastApprovalDate, application.RevisionDate, application.rev1ID, application.rev2ID,application.rev3ID, application.rev1Comments, application.rev2Comments, application.rev3Comments, application.rev1Approved, application.rev2Approved, application.rev3Approved, application.rev1ApprovedDate, application.rev2ApprovedDate, application.rev3ApprovedDate, ChairReviewDate, submissionFinishedDate, username, numContinued FROM application ORDER BY submissionFinishedDate ASC, App_Number ASC";
	  ...
	  <tr><td >   <p>&nbsp;</p>
		...
		<form name="form5" method="post" action="searchbyLastName.php">
         ...
         <form name="form2" method="post" action="irb_listAppbyStatus.php">
          ...
          <a href="irb_listAppbyLastName.php">List By Last Name</a></td>
 </tr>
