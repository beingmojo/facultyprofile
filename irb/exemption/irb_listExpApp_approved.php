...
$query_Recordset1 = "SELECT username, exemption.expNum, ReceiveDate FROM exemption where Approval = 'Yes' ORDER BY ReceiveDate DESC";
...
<tr><td colspan="6"><p>&nbsp;</p>
	    <div align="center">
	      <p><b>IRB EXEMPTION APPLICATIONS - APPROVED (Total: <?php echo $totalRows_Recordset1;?>)</b></p>
	      <p>&nbsp;</p>
	    </div></td></tr> 
		  <tr><td><strong>Applicant Name</strong></td><td><strong>Department</strong></td><td><strong>Application Number</strong></td><td><strong>Submission Date</strong><td></td><td></td><td></td></tr><tr ><td colspan="6">&nbsp;</td></tr>
...
echo "</td><td><a href='certificate_exp.php?expNum=". $row_Recordset1['expNum']."'>Print Certificate</a>";
	?>
  ...
  mysql_free_result($Recordset2);
	...
	echo "<tr><td colspan='6'><font color = 'red'>No Application found.</font></td></tr>";
   ?>
