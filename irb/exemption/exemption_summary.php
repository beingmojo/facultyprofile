...
<?php
mysql_select_db($database_con3, $con3);
$query_Recordset2 = "SELECT `user`.FirstName, `user`.LastName, `user`.Phone, `user`.Email, `user`.username, Department FROM `user` where username = '".$row_Recordset1['username']."'";
...
<tbody>
 ...
 <tr>
	...
	<tr><td> <div align="center">
	  <p><strong>APPLICATION FOR IRB EXEMPTION </strong></p>
	 
	</div></td></tr><tr><td><p><a href="irb_evaluationExemption.php?expNum=<?php echo $_GET['expNum'];?>" class="style21">Evaluate and Comment</a></p>
	    <HR>
          
          <p><strong>Application Number: </strong><span class="style52"><?php echo $_GET['expNum'];?></span><br />
	    
	    </p>
          <p align="left"><b>Applicant Information</b> </p>
          <blockquote>
            <p>Name: <u><?php echo $row_Recordset2['FirstName']." ".$row_Recordset2['LastName'];?></u> </p>
            <p>
              Department: <u><?php echo $row_Recordset2['Department'];?></u> </p>
            <p>
              Phone: <u><?php echo $row_Recordset2['Phone'];?></u></p>
            <p>
              Email: <u><?php echo $row_Recordset2['Email'];?></u>
    ...
    <tr>
      <td><blockquote class="style48"> &nbsp;<u>
          <span class="style51"><?php echo $row_Recordset1['academic_project']; ?></span></u>     </blockquote></td>
    </tr>
    <tr>
    ...
    <tr>
      <td><blockquote class="style48"> &nbsp;<u>
        <?php echo $row_Recordset1['contribute_knowledge']; ?> </u></blockquote></td>
    </tr>
    <tr>
    ...
    <tr>
      <td><div align="center"><span class="style46"><span class="style48"></span></span>
       
      </div></td>
    </tr>
    <tr>
      <td><h4><span class="style46"><span class="style48"></span></span></h4></td>
    </tr>
  </table>
