...
$query_Recordset1 = "SELECT exemption.expNum, username, ReceiveDate FROM exemption where (((Approval = 'Not')||(Approval = 'Not Yet')) || (appFinished ='No')) ORDER BY ReceiveDate DESC";
...
<p><a href="../<?php echo $_SESSION['myhome'];?>" class="irb">My IRB Home</a></span> <span class="style42">|</span> <a href="irb_listExpApp.php" class="irb">All IRB Exemption Applications</a> <span class="style42">|</span> <a href="../LogOut.php" class="irb">Log Out</a>
    ...
    <tr>
	  ...
	  <tr><td colspan="6"><p>&nbsp;</p>
	    <div align="center">
	      <p><b>IRB EXEMPTION APPLICATIONS - NOT APPROVED/APPLICATION IN REVIEW (Total: <?php echo $totalRows_Recordset1;?>)</b></p>
	      <p>&nbsp;</p>
	    </div></td></tr> 
