...
<select name="userID" id="userID" size="8">
<?php 
do {  
...
$query_Recordset3 = "SELECT application.App_Number, application.ProjectTitle FROM application WHERE ((application.rev1ID = '".$theValue."' || application.rev2ID = '".$theValue."' || application.rev3ID = '".$theValue."') && (application.Status != 'Approved'))";
