...
if (strpos($_POST['Email'], $substring) !== false) {
   ...
   die("Registrion failed! You need to use a valid email address. <a href='javascript:history.back()'>Back</a>");
}
      ...
      <input type="text" name="LastName">
        ...
        <div align="left">
          <input type="text" name="Phone">
              </div></td></tr><tr><td><div align="left">Email Address: <br> </div></td><td>
                <div align="left">
