...
$insertSQL = sprintf("INSERT INTO messages (EmailTime, FromEmail, ToEmail, Subject, Msg, appNum, EmailTime) VALUES (%s, %s, %s, %s, %s, %s, %s)",
...
Out</a></div></td>
    ...
    <tr>
      <td height="348" valign="top"><div align="center">
        ...
        <p align="left"><strong><a href="searchMail.php">List Messages </a></strong></p>
        <div align="left">
          <p>&nbsp;</p>
        </div>
        <ul>
        ...
        <p>&nbsp; </p>
        <p align="left">This is not a dedicated email server.  It is intended to be used for  IRB application related communication only. Please write your message as brife as possible.</p>
      </div>
