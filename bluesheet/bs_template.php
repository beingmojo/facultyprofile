...
?>
	...
	Director of OSP to submit proposals through the university:
                                    <ul>
	...
	This information only serves to help Texas State to comply with Export Control laws.
...
?>
		...
		shipped by OSP will be charged to the PI�s departmental UPS number.
                                </td></tr>
                        </table>
                            ...
                            <tr>
                                ...
                                <td rowspan="3" valign="top">
                                    <span id="si2">	I Prefer<br />
                                        <label><span style="visibility:hidden;">label</span><input id="siShipMethod1" name="siShipMethod" type="radio" value="OSP mails out my proposal" checked="checked"
                                                                                                   onclick="Hide('other', false, 'si3', 'si4')" /></label>
		    OSP to mail out my proposal.<br />
		    ...
		    to mail out my proposal myself.<br />
                                        <center><span class="tdSmall">(must have OSP approval,<BR />
			also OSP must have a copy of full proposal)</span></center>
                                    </span>
                                </td>
<?php
...
if (isset($sp_shipment_method)) {
                                            echo "<script>";
    if ($sp_shipment_method == "OSP mails out my proposal") {
...
<?php if (isset($proposal_type)) if($proposal_type=="Renewal/Non-competing continuation") echo "checked=\"checked\""; ?>/></label>
		...
		The personnel listed here should be Texas State employees <b>only</b>.
		Do not list any collaborators outside of Texas State.<Br />
		...
		investigator is not possible and blue sheet would need to be routed manually.
                        ...
                        <table width="100%" style="border-top: 1px dotted #0000CC" id="ciTable">
                            <tr>
                                <td colspan="4">
	Texas State personnel only  if you have any collaborators who are not Texas State employees, please fill in Section on External Collaborators and Subcontractors) If PI and Co-Investigators are from different Colleges or Administrative Units, Indirect Cost Recovery Percentages may be allocated between the departments/units by using the Facilities and Administration Distribution Form.This Form should be completed during the Proposal process, prior to submission.
                                </td>
                            </tr>
                            <tr></tr>
                            <tr>
	...
	Briefly summarize the project in lay terms.
		...
		please call your specialist or the department responsible for the area you have questions on.
                        ...
                        <table width="100%" style="border-top: 1px dotted #0000CC" id="complianceTable">
                            <tr>
                                <td colspan="6">
                                    Please review and attach the <a href="Compliance_Checklist.doc">Compliance Checklist</a> as necessary. Direct questions to 512-245-7975.<br /><br />
...
if (isset($human_subjects)) {
	...
	No</td>
		...
		Protocol #: <label><span style="visibility:hidden;">label</span><input name="pbAgentsNo" type="text" id="ccpbAgentsNo" size="6" <?php echo $baDT; ?> /></label></span>
                            ...
                            <tr>
                                <td colspan="6">
                                    <b>Environment Health & Safety: </b> EH & S can be reached at (512) 245-3616.
                                </td>
                            </tr>
                            <tr>
	...
	No</td>
		...
		If they will be paid from funds awarded to Texas State, they are considered �Subcontractors�.
		...
		Please see help in "Budget" section, below, for an explanation of consultants. 
                        ...
                        <table width="100%" style="border-top: 1px dotted #0000CC" id="extITable">
                            <tr>
                                <td colspan="4">
	This section is for external, non-involved, non-Texas State  personnel that will be listed on the proposal.  Please list only the lead investigator for each separate institution.  For method of funding, please select the option that applies to this proposal.
                                </td>
                            </tr>
                            <tr></tr>
                            <tr>
...
?>
                            ...
                            <tr>
                                ...
                                <td colspan="2"><label><span style="visibility:hidden">label</span>
                                        <select name="extFunded1" size="1" id="extFunded1">
                                            <option value="Subcontractor - Funded through Texas State's Budget">
		Subcontractor - Funded through Texas State's Budget</option>
                                            <option value="Consultant - Funded through Texas State's Budget">
		Consultant - Funded through Texas State's Budget</option>
                ...
                <tr>
                    <td colspan="3" valign="top">
                        <table width="100%" style="border-top: 1px dotted #0000CC; display:none;" id="faccTableHelp">
                            <tr><td class="tdSmall">
		The Texas State University at San Marcos has in place a negotiated Indirect Cost (IDC) Agreement with
		...
		Director of OSP. A reduction in IDC requires an adequate justification for the waiver
		...
		Enter the applicable percentage rate in the �F&A Percentage Rate� field.
                        ...
                        <table width="100%" style="border-top: 1px dotted #0000CC" id="faccTable">
                            <tr>
                                <td>
	Is the Standard University Rate allowed by the Sponsor? Please read the Descriptions located <a href="/bluesheet/Instructions.doc">here</a> and choose from the list below.<br />
                                    <a href="/bluesheet/idccost_distribfinal2006.doc"> IDC Cost Distribution Form</a>
                                        ...
                                        <LI>Salary consists of payments made to all faculty, staff, and students. Pay scales should be consistent for those used within your department and with Human Resources policies.
                                            <LI>Fringe rates are as follows: (insert estimated percentages when known)
                                                <LI>M&amp;O consists of all materials and supplies that cost less than $5,000 per unit or have a useful life of less than a year.
                                                    <LI>Consultants are individuals not employed by Texas State providing a service to the project. Human Subjects participating in research provide a service and are paid as consultants.
                                                        <LI>Sub-Contracts may require some additional information. Please contact your specialist if you anticipate using subcontractors.
                                                            <LI>Scholarships can only be provided under certain circumstances. Please contact your specialist before budgeting funds for scholarships.
                                                                <LI>Tuition is not permitted on any federal research proposals and only in certain situations on other proposals. Again, please contact your specialist before budgeting funds in this area.
                                                                    <LI>Participant Support is provided to individuals not employed by Texas State who may be participating in the research proposed. Participants are not required to provide services or receive payment contingent on an event. ONLY Students currently enrolled may be paid as Participant Support.
...
<?php $k=$k+1;?>
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                <td colspan="2">60 Consulting Services <span class="tdSmall">(non-Texas State)</span></td>
...
if (isset($_GET['ec_id']))
{
	...
	if ($row = mysql_fetch_array($result))
	{
		...
		$budgetYr4[$budgetCount] = $row["Yr4"];
		$budgetYr5[$budgetCount] = $row["Yr5"];
		$budgetName[$budgetCount] = "Consulting Services (non-Texas State)";
		$budgetTypeID[$budgetCount] = "4";
...
?>
                                                                                            ...
                                                                                            <script>
                                                                                                ...
                                                                                                newRow.id = tblName + newRow.rowIndex;
                                                                                                var id = newRow.id;
                                                                                                if ("<?php print($ei_funding[$i]);?>" == "Subcontractor - Funded through Texas State's Budget")
                                                                                                {
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td colspan="3" valign="top">
                                                                                                        <table width="100%" style="border-top: 1px dotted #0000CC; display:none;" id="scTableHelp">
                                                                                                            <tr><td class="tdSmall">
                                                                                                                    <a href="http://www.txstate.edu/research/orc/researcher-conflict-of-interest/financial-interest-disclosure/contentParagraph/0/document/FCOIFinIntDscnew.pdf">Conflict of
...
?>
		...
		Best Viewed in Internet Explorer, Firefox on Microsoft Windows & Firefox, Netscape on Mac.
                                                                                                <br /><br />
		"You may be entitled to know what information Texas State  collects concerning you. You may review and
		have Texas State correct this information according to procedures set forth in Texas State System BPM #32. The
		law is found in sections 552.021, 552.023 and 559.004 of the Texas Government Code. For more information, 
		see our <a href="https://facultyprofile.txstate.edu/privacypolicy.php">Privacy Policy</a>."
                                                                                            </div>
