...
$_POST['page-title'] = "Request New Technology Profile";
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="form_elements_row_action" id="basic_layout">
            ...
            <form action="requestnew.php" method="post" name="frmNewProfile" enctype='multipart/form-data' onSubmit='return validatefields()'>
                ...
                if (real_check_user_groupid($db_conn, "tech_admin") == true ||
                    ...
                    print( "<td>&nbsp;" .
                        ...
                        "size='10' maxlength='15' value='Patti Shannon' $readonly>" .
                        "<input class='form_elements_text' type='hidden' name='tech_general_info_login_id' " .
                        "size='10' maxlength='15' value='1000377751' $readonly> </td>");
                    print( "</tr>");
                }
	...
	<input name='cancel' type='button' class='form_elements' value='Cancel' onclick='location.href=\"myprofiles.php?#requestnew\"'/>
	</td></tr>");
                ?>
            </form>
