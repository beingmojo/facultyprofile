...
<table width="90%"  border="0" cellspacing="0" cellpadding="0" align="left">
    <tr>
        <td>
            ...
            &nbsp;&nbsp;
            <a href='f_info.php' style="text-decoration:none"><span class="details">(Account Info </span></a>
                    ...
                    while( $rowseditor = mysql_fetch_array( $result2 ) ) {
                        ...
                        if ($lastNameChar == $_GET['lnc'])
                            switch( $rowseditor[ "type_id" ] )//display picture based on profile type
                            {
								...
								<td width='20%' align='left'><a href='sections/gen_activate_profile_from_researchspace.php?pid=".$rowseditor["pid"]."' style='text-decoration:none'>$label</a></td>
                                                                <td width='20%' align='left'><a href='customize_profile.php?pid=".$rowseditor["pid"]."' style='text-decoration:none'>Editors</a></td>
							  	</tr>";
                                    break;
                                case 2: print "<td width='5%' align='left'><img src='images/bullets/center.gif' alt='Center Profile' /></td>";
                                    print "<td width='20%' align='left' class='form_elements' style='color:#555555'>".htmlspecialchars($lastName).", ".
