...
{	
	$deletequery = "DELETE FROM gen_profile_cluster WHERE type=1 AND pid = " . real_mysql_specialchars( $pid, true );
	$deleteresult = real_execute_query( $deletequery, $db_conn);
	
	$clusterquery = "SELECT cluster_id FROM gen_ind_cluster_types";
