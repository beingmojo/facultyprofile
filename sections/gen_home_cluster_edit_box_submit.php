...
{	
	$deletequery = "DELETE FROM gen_profile_cluster WHERE type=3 AND pid = " . real_mysql_specialchars( $pid, true );
	$deleteresult = real_execute_query( $deletequery, $db_conn);
	
	$clusterquery = "SELECT cluster_id FROM gen_home_cluster_types";
	...
	for($n=1;$n<=$noofclusters;$n++)
	{
	 ...
	 if($_POST[$fieldname]=='1')
	 {
		$insertquery = "INSERT INTO gen_profile_cluster (pid,cluster_id,type) VALUES ".
					...
					", " . real_mysql_specialchars( 3, true) .
					" ) ";		
