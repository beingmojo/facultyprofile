			...
			print( "<tr>" );
				...
				print( "<table width='100%'  border='0' cellspacing='0' >" );
					...
					print( "<tr >" );
						...
						if ( $ctr_info_rows[ "url_name" ] != "" )
						{
							$weblink = $ctr_info_rows[ "url_name" ] == "" ? "Web Link" : $ctr_info_rows[ "url_name" ];
							echo "<img alt='web' src='images/icons/web.gif' width='12' height='12' border='0' alt='Website' />" .
                                                        "&nbsp;&nbsp;<a href='http:". htmlspecialchars($ctr_info_rows[ "url_name" ]) . "'>" . htmlspecialchars($weblink) . "</a> &nbsp;&nbsp; ";
						}
						print( "</span>" );						
						print( "</td>" );
					print( "</tr>" );
