	...
	print( "<table width='100%'  border='0' cellspacing='0' cellpadding='0' id='eqp_description_view_box' class='visiblebox'>" );
		print( "<tr class='table_background'>" );
			...
			if( $editable == true )
			{
				...
				print( "<a href='#' style='text-decoration:none' onclick='return edit_box( \"eqp_description\",16777215 )'><img alt='edit' border='0' src='images/buttons/edit.gif'  > <span class='form_elements_section_action'>Edit &nbsp;</span></a>" );
			}
			print( "</td>" );
		print( "</tr>" );
		print( "<tr>" );
