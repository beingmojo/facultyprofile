...
if( real_can_user_edit( $db_conn, $pid ) == true )
{
	...
	for( $itr = 0 ; $itr < $rows; $itr ++ )
	{
		...
		if( $name != "" )
		{ 
			$query = "INSERT INTO fac_people ( pid, ppl_id, full_name, title, f_name, m_name, l_name, ppl_login_id, rank ) VALUES( " .
			...
			//print "values:".$name.$title.$f_name;
		}
	}
}

real_redirect( "../redirecttoeditprofile.php", "blah=foo&pid=$pid&view=$view&section_id=$section_id", $db_conn );
