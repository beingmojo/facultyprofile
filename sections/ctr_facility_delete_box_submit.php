...
if( real_can_user_edit( $db_conn, $pid ) == true )
{
	...
	{
		$query = 	"DELETE FROM gen_association USING gen_association, ctr_facility
						WHERE gen_association.pid = ctr_facility.fac_pid 
						AND gen_association.assoc_pid = ctr_facility.pid 
						AND ctr_facility.add_req = 0 
						AND ctr_facility.pid = " . real_mysql_specialchars( $pid, true );
