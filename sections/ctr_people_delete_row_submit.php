...
if( real_can_user_edit( $db_conn, $pid ) == true )
{
	...
	$query = 	"DELETE FROM gen_association USING gen_association, ctr_people 
					WHERE gen_association.assoc_login_id = ctr_people.ppl_login_id 
					AND gen_association.pid = ctr_people.pid 
					AND ctr_people.ppl_id = " . real_mysql_specialchars( $pp_id, true ) . 
				"	AND ctr_people.pid  = " . real_mysql_specialchars( $pid, true );
	real_execute_query( $query, $db_conn );
	
	$query = "DELETE FROM ctr_people " .
