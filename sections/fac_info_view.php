<?php
if( mysql_num_rows( $fac_general_info_results ) > 0 )
	mysql_data_seek( $fac_general_info_results, 0 );
$generalrows = mysql_fetch_array( $fac_general_info_results );
print( "<table width='100%'  border='0' cellspacing='0' cellpadding='0' >" );
	...
	print( "</tr>" );
	print("<table width='100%'  border='0' cellspacing='0' cellpadding='0' id='fac_general_info_view_box' class='visiblebox'>" );
		if( $generalrows["fac_image_id"] != 0 )
		{
			print( "<td align='center' valign='middle' width='128' style='border:1px solid black'>" );
			print( "<a href='images/0/" . $pid . "_0_" . $generalrows["fac_image_id"] . ".jpg' target='_blank'><img src='images/128/". "$pid" . "_0_" . $generalrows["fac_image_id"] . ".jpg" . "' border='0' alt='" . $generalrows["name"] . "' ></a>" );
			print( "</td>" );
			print( "<td width='5'></td>" );
		}
		...
		print( "<table width='100%'  border='0' cellspacing='0' cellpadding='0' >" );
			print( "<tr class='table_background'>" );
				...
				if( $editable == true )
				{
					print( "<a href='#' style='text-decoration:none' onclick='return edit_box( \"fac_general_info\" )'><img alt='edit' border='0' src='images/buttons/edit.gif'  > <span class='form_elements_section_action'>Edit &nbsp;</span></a>" );
				}
				print( "</td>" );
			print( "</tr>" );
			print( "<tr >" );
			...
			print( "</tr>" );
				...
				if ( $generalrows[ "url_name" ] != "")
				{
					...
					echo "<span class='form_elements_text'><a href='" . htmlspecialchars($generalrows[ "url_name" ]) . "' target='_blank'>" . $urlname ."</a></span>" ;
					print( "&nbsp; &nbsp;" );
				}
				print( "</td>" );
