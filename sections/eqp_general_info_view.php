...
print("<table width='100%'  border='0' cellspacing='0' cellpadding='0' id='eqp_general_info_view_box' class='visiblebox'>" );
	print( "<tr >" );
	...
	print( "<tr>" );
		if( $generalrows["image_id"] != 0 )
		{
			...
			print( "<img src='images/128/". "$pid" . "_0_" . $generalrows["image_id"] . ".jpg" . "' alt='" . htmlspecialchars($generalrows["title"], ENT_QUOTES) ." ". htmlspecialchars($generalrows["f_name"], ENT_QUOTES) ." ". htmlspecialchars($generalrows["m_name"], ENT_QUOTES) ." ". htmlspecialchars($generalrows["l_name"], ENT_QUOTES) . "' >" );
			print( "</td>" );
			print( "<td width='5'></td>" );
		}
		...
		print( "<table width='100%'  border='0' cellspacing='0' cellpadding='0' >" );
			print( "<tr class='table_background'>" );
				...
				if( $editable == true )
				{
					print( "<a href='#' style='text-decoration:none' onclick='return edit_box( \"eqp_general_info\" )'><img alt='edit' border='0' src='images/buttons/edit.gif'  > <span class='form_elements_section_action'>Edit &nbsp;</span></a>" );
				}
				print( "</td>" );
			print( "</tr>" );
			print( "<tr>" );
			...
			print( "<tr >" );
				...
				if ( $generalrows[ "contact_email" ] != "" )
					echo "<img alt='mail' src='images/icons/mail.png' width='12' height='12' border='0' alt='Email' />" .
					 "&nbsp;&nbsp;<a href='mailto:". htmlspecialchars($generalrows[ "contact_email" ], ENT_QUOTES) . "'>" . htmlspecialchars($generalrows[ "email_id" ]) . "</a> &nbsp;&nbsp; ";
				...
				if ( $generalrows[ "url_name" ] != "")
				{
					$urlname = $generalrows[ "url_name" ] == "" ? "Web Link" : htmlspecialchars($generalrows[ "url_name" ]);
					echo "<img alt='web' src='images/icons/web.gif' width='12' height='12' border='0' alt='".htmlspecialchars($urlname, ENT_QUOTES)."' /> ";
					echo "<span class='form_elements_text'><a href='" . htmlspecialchars($generalrows[ "url_name" ], ENT_QUOTES) . "' target='_blank'>" . htmlspecialchars($urlname) ."</a></span>" ;
					print( "&nbsp; &nbsp;" );
				}
				print( "</span>" );						
				print( "</td>" );
			...
			print( "<tr>" );
				...
				{
					echo "<img alt='hours' src='images/icons/hours.gif' width='12' height='12' border='0' alt='Keywords' /> ";
...
print( "<script type='text/javascript'>" );
	print( "function ShowProfile( url_name )" );
	print( "{" );
		print( "hide_popup( \"gen_association\" );" );
		print( "location.href=url_name" );
	print( "}" );
print( "</script>" );
