<?php
	$tech_solution_query = "SELECT * FROM tech_solution WHERE pid = " . real_mysql_specialchars( $pid, true ) ;
	$tech_solution_results = real_execute_query ( $tech_solution_query, $db_conn );
/*
	if( $editable == true )
	{
