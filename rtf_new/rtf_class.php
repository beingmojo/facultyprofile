...
//-------------------------------------------------------------------------------------------------
	function twips($num) { // great thanks to Ian M. Nordby for this function
		...
		if (eregi('^(-?[0-9]+(\.[0-9]+)?)[ ]?(mm|cm|q|kyu|in|pt|pts|picas|twips)$',trim("$num"),$regs)) {
...
//-------------------------------------------------------------------------------------------------
		$string=eregi_replace("<cpagenum>", $slash."chpgn ", $string);
		$string=eregi_replace("\r", "", $string);$string=eregi_replace("\n", "", $string);
		$string=eregi_replace("<u>", "<U>", $string);$string=eregi_replace("<U>", $slash."ul ", $string);
		$string=eregi_replace("</u>", "</U>", $string);$string=eregi_replace("</U>", $slash."ul0 ", $string);
		$string=eregi_replace("<i>", "<I>", $string);$string=eregi_replace("<I>", $slash."i ", $string);
		$string=eregi_replace("</i>", "</I>", $string);$string=eregi_replace("</I>", $slash."i0 ", $string);
		$string=eregi_replace("<b>", "<B>", $string);$string=eregi_replace("<B>", $slash."b ", $string);
		$string=eregi_replace("</b>", "</B>", $string);$string=eregi_replace("</B>", $slash."b0 ", $string);
		$string=eregi_replace("<br>", "<BR>", $string);$string=eregi_replace("<BR>", " ".$slash."line ", $string);
		$string=eregi_replace("<sup>", "<SUP>", $string);$string=eregi_replace("<SUP>", $fig_l.$slash."super ", $string);
		$string=eregi_replace("</sup>", "</SUP>", $string);$string=eregi_replace("</SUP>", $fig_r, $string);
		$string=eregi_replace("<sub>", "<SUB>", $string);$string=eregi_replace("<SUB>", $fig_l.$slash."sub ", $string);
		$string=eregi_replace("</sub>", "</SUB>", $string);$string=eregi_replace("</SUB>", $fig_r, $string);
		$string=eregi_replace("<new page>"," ".$slash."page ", $string);
		$string=eregi_replace("<newcol>"," ".$slash."column ", $string);
//-------------
//		$string=eregi_replace("<header>", "<HEADER>", $string);$string=eregi_replace("<HEADER>", $fig_l.$slash."header ".$slash."pard".$slash."plain ".$slash."q".$this->get_align($this->header_align)." ".$fig_l, $string);
//		$string=eregi_replace("</header>", "</HEADER>", $string);$string=eregi_replace("</HEADER>", $fig_r.$fig_l.$slash."par ".$fig_r.$fig_r, $string);


		$string=eregi_replace("<header>", "<HEADER>", $string);$string=eregi_replace("<HEADER>", $fig_l.$slash."header ".$slash."pard".$slash."plain ".$slash."q".$this->get_align($this->header_align)." ", $string);
		$string=eregi_replace("</header>", "</HEADER>", $string);$string=eregi_replace("</HEADER>", $slash."par ".$fig_r, $string);
//-------------
		$string=eregi_replace("<footer>", "<FOOTER>", $string);$string=eregi_replace("<FOOTER>", $fig_l.$slash."footer ".$slash."pard".$slash."plain ".$slash."q".$this->get_align($this->footer_align)." ".$fig_l, $string);
		$string=eregi_replace("</footer>", "</FOOTER>", $string);$string=eregi_replace("</FOOTER>", $fig_r.$fig_l.$slash."par ".$fig_r.$fig_r, $string);
// if facing_pages is activated:
		$string=eregi_replace("<headerr>", "<HEADERR>", $string);$string=eregi_replace("<HEADERR>", $fig_l.$slash."headerr ".$slash."pard".$slash."plain ".$slash."q".$this->get_align($this->header_align)." ", $string);
		$string=eregi_replace("</headerr>", "</HEADERR>", $string);$string=eregi_replace("</HEADERR>", $slash."par ".$fig_r, $string);
//-------------
		$string=eregi_replace("<footerr>", "<FOOTERR>", $string);$string=eregi_replace("<FOOTERR>", $fig_l.$slash."footerr ".$slash."pard".$slash."plain ".$slash."q".$this->get_align($this->footer_align)." ".$fig_l, $string);
		$string=eregi_replace("</footerr>", "</FOOTERR>", $string);$string=eregi_replace("</FOOTERR>", $fig_r.$fig_l.$slash."par ".$fig_r.$fig_r, $string);
//-------------
		$string=eregi_replace("<headerl>", "<HEADERL>", $string);$string=eregi_replace("<HEADERL>", $fig_l.$slash."headerl ".$slash."pard".$slash."plain ".$slash."q".$this->get_align($this->header_align)." ", $string);
		$string=eregi_replace("</headerl>", "</HEADERL>", $string);$string=eregi_replace("</HEADERL>", $slash."par ".$fig_r, $string);
//-------------
		$string=eregi_replace("<footerl>", "<FOOTERL>", $string);$string=eregi_replace("<FOOTERL>", $fig_l.$slash."footerl ".$slash."pard".$slash."plain ".$slash."q".$this->get_align($this->footer_align)." ".$fig_l, $string);
		$string=eregi_replace("</footerl>", "</FOOTERL>", $string);$string=eregi_replace("</FOOTERL>", $fig_r.$fig_l.$slash."par ".$fig_r.$fig_r, $string);





		$string=eregi_replace("<tab>", "<TAB>", $string);$string=eregi_replace("<TAB>", $slash."tab ", $string);
		$string=eregi_replace("<hr>", "<HR>", $string);$string=eregi_replace("<HR>", $slash."brdrb".$slash."brdrs".$slash."brdrw15".$slash."brsp20  ".$slash."par".$slash."pard ", $string);
