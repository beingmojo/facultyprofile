...
function GetEmailText($bs_id) {
    ...
    $email_text .= 	" " .
            "\n ------------------------------------------------------------------------------- \n" .
            "Technical Questions/Difficulties call 2-1060 or email office@institution.edu . \n" .
            ...
            "If you are receiving multiple emails for the same bluesheet, please submit a preferred email address to office@institution.edu & we will add it for future routing.";
    return $email_text;
}
    ...
    if (isset($_GET['id'])) {
        ...
        while($row2 = mysql_fetch_array($result2)) {
            ...
            while($row3 = mysql_fetch_array($result3)) {
                ...
                $message = "Dear " . $a_name . ": \n\n" . GetEmailText($bs_id);
                mail( $a_email, "Bluesheet returned", $message, "From: GCS<office@institution.edu>" );
            }
        ...
        if ($alldone == true) {
            ...
            mail( "vpr@institution.edu", "Pending Bluesheet Final Review", $message, "From: GCS<office@institution.edu>" );

            $message = "Dear Sir/Madam: \n\n" .
                    "A Internal Routing Form (bluesheet) is pending review from you.\n" .
                    "Please login to research space portal at http://{$_SERVER['HTTP_HOST']}{$_home}/loginscreen.php?view=2 to approve/return this bluesheet.\n\n" .
                    "Thank you.\n-------------------------\nElectronic Research Administration";
            mail( "ogcsdir@institution.edu", "Pending Bluesheet Final Review", $message, "From: GCS<office@institution.edu>" );
        ...
        if ($complete == true) {
            ...
            if($row3 = mysql_fetch_array($result3)) {
                $message = "Dear Sir/Madam: \n\n " .
                        ...
                        "Thank you.\n-------------------------\nElectronic Research Administration";
                mail( $row3["email"], "Bluesheet Reviewed", $message, "From: GCS<office@institution.edu>\r\nCc: office@institution.edu\r\n" );
            }
...
<html>
    ...
    <body>
	  ...
	  GRANT &amp; CONTRACT SERVICES - THE UNIVERSITY OF TEXAS AT ARLINGTON<br>
	  BOX 19145 - PHONE 817-272-2105 - WEB: <a href="http://www.uta.edu/ra/GCS/gcs.html" target="_blank">http://www.uta.edu/ra/GCS/gcs.html</a>	  </center>
                    <br>
                    <table width="99%"  style="border:1px solid #000000" bordercolor="#000000" cellspacing="0" cellpadding="5">
                        <tr>
                            ...
                            <td width="30%" align="left" valign="top" style="border-bottom: 1px dashed #000000;border-left: 1px dashed #000000">
                                <span class="sectionHeader1"><center>For GCS Use Only</center></span>
                                <table>
                                    <tr>
                                        <td>GCS#: _________________________</td>
                                    </tr>
...
<?php print($sp_shipment_method);?>
                        ...
                        <tr>
                            <td colspan="4" align="left" valign="top">
                                ...
                                <b>(UTA personnel only &ndash; if you have any collaborators who are not UTA employees,
				...
				by using the <a href="http://www.uta.edu/ra/GCS/Forms.php" target="_blank">Facilities 
			  ...
			  project in lay terms)<br>
                        ...
                        <tr>
                            <td colspan="4" align="left" style="border-bottom: 1px dashed #000000">
                                <div id="b2"></div>
                                <span class="sectionHeader1">6. Compliance</span> Please review and attach the Compliance Checklist as necessary. Direct questions to x2-3723 Office of Research Compliance: Please choose Yes, No, or Pending.<br>
                                Human Subjects: <b>
<? 
...
?></b><br>
				Select Agents: <b><?php print($select_agents);?> </b><br>
                                <a href="http://www.uta.edu/ehsafety/" target="_blank">Environmental Health &amp; Safety</a> - EH &amp; S can be reached at x2-2185<br>
...
if (($radioactive_materials!="Yes") && ($radioactive_materials!="No") && ($radioactive_materials!="Pending")) {
    echo "Approved Date - " . $radioactive_materials;
			  ...
			  This section is for <b>non-UTA</b> external personnel that will be  listed on the proposal. Please list only 
...
for($i=0; $i<$budgetCount; $i++) {
    if ($budgetName[$i] == "mtdc") {
        ...
        echo "  <td align=\"center\">$budgetYr3[$i]</td>";
                        ...
                        <tr>
                            <td colspan="4" align="left"><a href="Instructions.htm#10" target="_blank" style="cursor:help"><b>Unrecovered Facilities &amp; Administration (IDC)</b></a> (reserved for GCS use) <br>
                                <br>
				...
				Will this project involve shipping equipment to foreign countries or training persons in its use (regardless of location)? <b><?php print($sc6);?></b><br>
                        ...
                        <tr>
                            <td colspan="4" align="left"><span class="sectionHeader1">Investigator's Certification:</span><br>
                                ...
                                <ol type="a">
                                    ...
                                    <li>I  have reviewed and understood the <a href="http://www.uta.edu/ra/GCS/Forms.php">Compliance  Checklist</a>.</li>
                                    <li>I have reviewed and understood the <a href="http://www.uta.edu/ra/RC/OtherPolicies.php?&l=1">Export Control  Regulations</a>.</li>
				  ...
				  them, except as noted. I have reviewed the proposal for compliance with 
                                <a href="../../../RC/OtherPolicies.php?&l=1">Export Control Regulations</a> and
                                <a href="../../../RC/OtherPolicies.php">Research Compliance Policies</a>
                            </td>
                        </tr>
<?
...
if (isset($bs_id)) {
    ...
    while($row = mysql_fetch_array($result_i)) {
        ...
        $chair_approval = ApprovalStatus($ds[0][3], $bs_id);
                        ...
                        ?>
                                <table style="border-top: 1px solid #000000;" width="100%"><tr>
                                        <td align="center" width="100%">GCS Initials</td>
                                    </tr></table>
                            </td>
                        </tr>
