...
?>
<tr>
    <td style="background-color:#480000;color:#CCCCCC;" height="10px"><span style="margin-top:2px;margin-left:10px;font-family:times,san-serif;font-weight:bold;font-size:16px">Create New Equipment Profile</span></td>
</tr>
</table>
<style>
    body {
        ...
        <td colspan="2">
            ...
            <form action="createnew.php" method="post" name="frmNewProfile" enctype='multipart/form-data' onSubmit='return validatefields()'>
                ...
                if( real_check_user_groupid( $db_conn, "admin" ) == true ) {
                    ...
                    print( "<td>&nbsp;<input class='form_elements_edit' type='text' id='eqp_general_info_login_name' name='eqp_general_info_login_name' size='30' maxlength='255' value='' readonly> " );
                ...
                print( "<tr>" );
                print( "<td>&nbsp;<span class='form_elements_text'><B>Description</B></span></td>" );
