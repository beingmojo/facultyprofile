...
//$pid=1;
        ...
        ?>
        <title>Research Profile System - (NIH Biographical Sketch - Step by Step Builder) - Texas State University - San Marcos</title>
        <!-- InstanceEndEditable -->
...
while($r3=mysql_fetch_array($res3)) {
                                            ...
                                            <tr>
                                                ...
                                                <td width="53%"><div align="left">
                                                        <input name="inst_<?php print $count3;?>" type="text" class="form_elements" id="major_<?php print $count3;?>" value="<?php print $r3["dept_school"];
    if($r3["dept_school"]!='')
        print ", ";
    print $r3["off_school"];
    if($r3["off_school"]!='')
