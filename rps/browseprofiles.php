...
switch ($view) {
    case 1:
        $query = "SELECT DISTINCT T1.pid, T1.name, T2.image_id, T2.keywords, T2.pri_designation, 'Keywords' FROM gen_profile_info T1,".
                " ppl_general_info T2 ";
        if( $hid_list != "" )
            $query .= " , gen_profile_hierarchy T3 ";
        $query .= " WHERE T1.pid = T2.pid AND type_id=" .real_mysql_specialchars($view, true);
        if( $hid_list != "" )
            $query .= " AND T1.pid = T3.pid AND T3.hid IN ( $hid_list ) ";
    ...
    /* view==3 & type==1 -------> Patents
        ...
        if($view==3 & $type==1) {
            $querynumrows="SELECT DISTINCT T1.pid, T1.name, T1.image_id, T1.keywords, '', 'Keywords' FROM tech_gen_info T1 ,tech_status T2, gen_profile_info T3	WHERE T1.pid = T2.pid  AND T2.type =1 and t3.pid=t1.pid and t3.status=0" ;

            $resultnumrows  = real_execute_query($querynumrows,$db_conn);
            $numrows = mysql_num_rows($resultnumrows);
            $maxPage = ceil($numrows/$rowsPerPage);

            $query = "SELECT DISTINCT T1.pid, T1.name, T1.image_id, T1.keywords, '', 'Keywords' FROM tech_gen_info T1 ,tech_status T2 , gen_profile_info T3  WHERE T1.pid = T2.pid  AND T2.type =1 AND T3.pid=t1.pid and t3.status=0 ORDER BY name ASC LIMIT $offset, $rowsPerPage" ;
        }
        else if($view==3 & $type==2) {
            $querynumrows = "SELECT DISTINCT T1.pid, T1.name, T1.image_id, T1.keywords, '', 'Keywords' FROM tech_gen_info T1 ,tech_status T2 , gen_profile_info t3	WHERE t3.pid=T1.pid and t3.status=0 and t1.pid = T2.pid  AND T2.type = 2";

            $resultnumrows  = real_execute_query($querynumrows,$db_conn);
            $numrows = mysql_num_rows($resultnumrows);
            $maxPage = ceil($numrows/$rowsPerPage);

            $query = "SELECT DISTINCT T1.pid, T1.name, T1.image_id, T1.keywords, '', 'Keywords' FROM tech_gen_info T1 ,tech_status T2, gen_profile_info T3 WHERE t3.pid=t1.pid and t3.status=0 and T1.pid = T2.pid  AND T2.type = 2 ORDER BY name ASC LIMIT $offset, $rowsPerPage" ;
        }
        else {
            $query = "SELECT T1.pid, T1.name, T2.image_id, T2.keywords, '', 'Keywords' FROM gen_profile_info T1,".
                    " tech_gen_info T2 WHERE T1.pid = T2.pid AND type_id=".real_mysql_specialchars($view, true).
...
?>
<tr>
    <td style="background-color:#480000;color:#CCCCCC;" height="10px"><span style="margin-top:2px;margin-left:10px;font-family:times,san-serif;font-weight:bold;font-size:16px">Browse Profiles</span></td>
</tr>
</table>
<style>
    body {
...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/level1.dwt.php" codeOutsideHTMLIsLocked="false" -->
    <head>
        ...
        <title>Research Profile System - (Browse Profiles) - Texas State University - San Marcos</title>
                ...
                <td colspan="2">
                    ...
                    switch ($view) {
                        case 1: //specifiying tab actions
                            print( "<td style='background:url(images/tabblue.gif);' width='111' height='33' valign='bottom' align='center'><span class='tab_menu'>Faculty</span></td>" );
                            print( "<td style='background:url(images/tabsilver.gif);' width='111' valign='bottom' align='center' ><span class='tab_menu'><a href='browseprofiles.php?view=2' style='text-decoration:none'>Centers</a></span></td>" );
                            print( "<td style='background:url(images/tabsilver.gif);' width='111' valign='bottom' align='center' ><span class='tab_menu'><a href='browseprofiles.php?view=3' style='text-decoration:none'>Technologies</a></span></td>" );
                            //print( "<td style='background:url(images/tabsilver.gif);' width='111' valign='bottom' align='center' ><span class='tab_menu'><a href='browseprofiles.php?view=4' style='text-decoration:none'>Facilities</a></span></td>" );
                            print( "<td style='background:url(images/tabsilver.gif);' width='111' valign='bottom' align='center' ><span class='tab_menu'><a href='browseprofiles.php?view=5' style='text-decoration:none'>Equipment</a></span></td>" );
                           // print( "<td style='background:url(images/tabsilver.gif);' width='111' valign='bottom' align='center' ><span class='tab_menu'><a href='browseprofiles.php?view=6' style='text-decoration:none'>Labs &amp; Groups</a></span></td>" );

                            $topage='editprofile.php';
                            break;
                        case 2:
                            print( "<td style='background:url(images/tabsilver.gif);' height='33' width='111' valign='bottom' align='center'><span class='tab_menu'><a href='browseprofiles.php?view=1' style='text-decoration:none'>Faculty</a></span></td>" );
                            print( "<td style='background:url(images/tabblue.gif);' width='111' valign='bottom' align='center' ><span class='tab_menu'>Centers</span></td>" );
                            print( "<td style='background:url(images/tabsilver.gif);' width='111' valign='bottom' align='center' ><span class='tab_menu'><a href='browseprofiles.php?view=3' style='text-decoration:none'>Technologies</a></span></td>" );
                           // print( "<td style='background:url(images/tabsilver.gif);' width='111' valign='bottom' align='center' ><span class='tab_menu'><a href='browseprofiles.php?view=4' style='text-decoration:none'>Facilities</a></span></td>" );
                            print( "<td style='background:url(images/tabsilver.gif);' width='111' valign='bottom' align='center' ><span class='tab_menu'><a href='browseprofiles.php?view=5' style='text-decoration:none'>Equipment</a></span></td>" );
                            //print( "<td style='background:url(images/tabsilver.gif);' width='111' valign='bottom' align='center' ><span class='tab_menu'><a href='browseprofiles.php?view=6' style='text-decoration:none'>Labs &amp; Groups</a></span></td>" );
                        ...
                        case 3:
                            print( "<td style='background:url(images/tabsilver.gif);' height='33' width='111' valign='bottom' align='center'><span class='tab_menu'><a href='browseprofiles.php?view=1' style='text-decoration:none'>Faculty</a></span></td>" );
                            print( "<td style='background:url(images/tabsilver.gif);' width='111' valign='bottom' align='center' ><span class='tab_menu'><a href='browseprofiles.php?view=2' style='text-decoration:none'>Centers</a></span></td>" );
                            print( "<td style='background:url(images/tabblue.gif);' width='111' valign='bottom' align='center' ><span class='tab_menu'>Technologies</span></td>" );
                            //print( "<td style='background:url(images/tabsilver.gif);' width='111' valign='bottom' align='center' ><span class='tab_menu'><a href='browseprofiles.php?view=4' style='text-decoration:none'>Facilities</a></span></td>" );
                            print( "<td style='background:url(images/tabsilver.gif);' width='111' valign='bottom' align='center' ><span class='tab_menu'><a href='browseprofiles.php?view=5' style='text-decoration:none'>Equipment</a></span></td>" );
                            //print( "<td style='background:url(images/tabsilver.gif);' width='111' valign='bottom' align='center' ><span class='tab_menu'><a href='browseprofiles.php?view=6' style='text-decoration:none'>Labs &amp; Groups</a></span></td>" );
                            $topage='editprofile.php';
                        ...
                        case 4:
                            ...
                            print( "<td style='background:url(images/tabsilver.gif);' width='111' valign='bottom' align='center' ><span class='tab_menu'><a href='browseprofiles.php?view=2' style='text-decoration:none'>Centers</a></span></td>" );
                            print( "<td style='background:url(images/tabsilver.gif);' width='111' valign='bottom' align='center' ><span class='tab_menu'><a href='browseprofiles.php?view=3' style='text-decoration:none'>Technologies</a></span></td>" );
                            //print( "<td style='background:url(images/tabblue.gif);' width='111' valign='bottom' align='center' ><span class='tab_menu'>Facilities</span></td>" );
                            print( "<td style='background:url(images/tabsilver.gif);' width='111' valign='bottom' align='center' ><span class='tab_menu'><a href='browseprofiles.php?view=5' style='text-decoration:none'>Equipment</a></span></td>" );
                            //print( "<td style='background:url(images/tabsilver.gif);' width='111' valign='bottom' align='center' ><span class='tab_menu'><a href='browseprofiles.php?view=6' style='text-decoration:none'>Labs &amp; Groups</a></span></td>" );
                            $topage='editprofile.php';
                            break;
                        case 5:
                            ...
                            print( "<td style='background:url(images/tabsilver.gif);' width='111' valign='bottom' align='center' ><span class='tab_menu'><a href='browseprofiles.php?view=3' style='text-decoration:none'>Technologies</a></span></td>" );
                           // print( "<td style='background:url(images/tabsilver.gif);' width='111' valign='bottom' align='center' ><span class='tab_menu'><a href='browseprofiles.php?view=4' style='text-decoration:none'>Facilities</a></span></td>" );
                            print( "<td style='background:url(images/tabblue.gif);' width='111' valign='bottom' align='center' ><span class='tab_menu'>Equipment</span></td>" );
                            //print( "<td style='background:url(images/tabsilver.gif);' width='111' valign='bottom' align='center' ><span class='tab_menu'><a href='browseprofiles.php?view=6' style='text-decoration:none'>Labs &amp; Groups</a></span></td>" );
                            $topage='editprofile.php';
                            break;
                        case 6:
                           ...
                           // print( "<td style='background:url(images/tabsilver.gif);' width='111' valign='bottom' align='center' ><span class='tab_menu'><a href='browseprofiles.php?view=4' style='text-decoration:none'>Facilities</a></span></td>" );
                            print( "<td style='background:url(images/tabsilver.gif);' width='111' valign='bottom' align='center' ><span class='tab_menu'><a href='browseprofiles.php?view=5' style='text-decoration:none'>Equipment</a></span></td>" );
                           // print( "<td style='background:url(images/tabblue.gif);' width='111' valign='bottom' align='center' ><span class='tab_menu'>Labs &amp; Groups</span></td>" );
                            $topage='editprofile.php';
                            break;
			...
			exit();
                    ...
                    */
                    ...
                    if($view==1) {
                        ...
                        print "</select>&nbsp;&nbsp;</label>\n<input name='go' id='go' type='button' value='Go' onclick='filterbydept()' /></td></tr>";
                    ...
                    if($view==3) {
                        ...
                        if($type!=1)
                            print("<a href='browseprofiles.php?view=3&amp;type=1'>Patents</a>" );
                        else
                            print "Patents";
                        print("&nbsp; |&nbsp; ");
                        if($type!=2)
                            print("<a href='browseprofiles.php?view=3&amp;type=2'>Patents in Application</a>" );
                        else
                            print "Patents in Application";
                        print("&nbsp; |&nbsp; ");
//		  print("  <img src='images/bullets/blue.png' /> ");
                        if($type!="")
                            print("<a href='browseprofiles.php?view=3'>Browse All</a>" );
                        else
                            print "Browse All";
                        print("</font>");
                        print("<br>");
                    ...
                    while($row=mysql_fetch_array($result)) {
                        if($altrow==1)
                            $class='table_background_other';
                        else
                            $class='table_background_viewedit';
                        print "\n<tr>";
                        print "<td width='48' height='48' valign='middle' align='center' rowspan='2' class='".$class."' style='border:1px solid white'>";
                        if($row[2]!=0)
                            if($view == 5 )
                                print "<a href='".$topage."?pid=".$row[0]."&amp;onlyview=1#".$jumpto."'><img src='images/48/".$row[0]."_6_".$row[2].".jpg' alt='' border='0'></a>";
                            else
                                print "<a href='".$topage."?pid=".$row[0]."&amp;onlyview=1'><img src='images/48/".$row[0]."_0_".$row[2].".jpg' alt='' border='0'></a>";
                        print "</td>";
                        ...
                        if($view == 5)
                            print "<a href='".$topage."?pid=".$row[0]."&amp;onlyview=1#".$jumpto."'>".htmlspecialchars($row[1])."</a>";
                        else
                            print "<a href='".$topage."?pid=".$row[0]."&amp;onlyview=1'>".htmlspecialchars($row[1])."</a>";
                        print "</span></td>";
                        print "</tr>";
                        print "<tr>";
                        ...
                        if( $row[4] != "" )
                            print( "<B>".htmlspecialchars($row[4])."</B><BR>" );
                        if( $row[3] != "" )
                            print( htmlspecialchars($row[5]).":&nbsp;".htmlspecialchars($row[3]) );
                        print( "</td>" );
                        print "</tr>";
                        //      print "<tr>".
                        //            "<td colspan='2'>&nbsp;</td>".
