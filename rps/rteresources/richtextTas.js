...
function writeRichText(rte, rtename, html, width, height, buttons, readOnly, isTextArea) {
	if (isRichText) {
		...
		if (buttons == true) {
			ocument.writeln('<table class="rteBack" cellpadding=2 cellspacing=0 id="Buttons1_' + rte + '" width="' + tablewidth + '">');
			document.writeln('	<tr>');
			document.writeln('		<td>');
	...
	//		document.writeln('		<td><img class="rteImage" src="' + imagesPath + 'redo.gif" width="25" height="24" alt="Redo" title="Redo" onClick="rteCommand(\'' + rte + '\', \'redo\')"></td>');
		...
		document.writeln('<iframe width="200" height="200" id="cp' + rte + '" src="' + includesPath + 'palette.htm" marginwidth="0" marginheight="0" scrolling="yes" style="visibility:hidden; position: absolute;"></iframe>');
