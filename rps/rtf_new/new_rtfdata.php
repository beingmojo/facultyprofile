...
$text = "<footer><font size=8 color=#666666><b>Generated Using Research Profile </b>
		<a file=http://www.uta.edu/expertise.html> http://www.uta.edu/expertise</a></font></footer>";
$rtf->parce_html($text);
...
$text = "<p><table border=0><tr><td width=60%>".$r1['pri_designation']."</td><td rowspan=5></td></tr>
 							<tr><td>University of Texas at Arlington</td><td></td></tr>
...
//displaying education and training information header
$text = "<br><table border=0><tr><td bgcolor=#666666><b>Education / Training</b></td></tr></table>";
$rtf->parce_html($text);
...
$text = "<br><table border=0><tr><td bgcolor=#666666><b>Positions and Honors</b></td></tr></table>";
$rtf->parce_html($text);
...
$text = "<br><table border=0><tr><td bgcolor=#666666><b>Research Support</b></td></tr></table>";
$rtf->parce_html($text);
...
{		
	...
	{	$text = "<br><table border=0><tr><td bgcolor=#666666><b>Ongoing Research Support</b></td></tr></table>";
		$rtf->parce_html($text);
		$test1 =false;
	}
	if ($test2 == true && $r5['prj_status']==2 )
	{	$text = "<br><table border=0><tr><td bgcolor=#666666><b>Completed Research Support</b></td></tr></table>";
		$rtf->parce_html($text);
		$test2 = false;
		
	}
	if ($test3 == true && $r5['prj_status']==3 )
	{	$text = "<br><table border=0><tr><td bgcolor=#666666><b>Pending Research Support</b></td></tr></table>";
		$rtf->parce_html($text);
		$test3 = false;
