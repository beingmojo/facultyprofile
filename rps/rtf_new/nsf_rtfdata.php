...
$file_rtf = "Biographical Sketch.rtf";
...
$text = "<p><table border=0><tr><td align=center>".$r1['pri_designation']."</td></tr>
 							<tr><td align=center>University of Texas at Arlington</td></tr>
...
{
	$text= "<p><table border=0><tr><td width=6% align=center><b>".$i.".</b></td><td>".$r3['s_date'] ." - ".$r3['e_date'].",<b> ".$r3['rank'].",</b> Department of ".$r3['dept_school'].", ".$r3['univ_comp'].". "."</td></tr></table>";
	$rtf->parce_html($text);
	$i++;
...
{	
	if($i < 11)
	{
		$text= "<table border=0><tr><td width=6% align=center><b>".$i.".</b>"."</td><td align=justify>".strip_tags($r4['name'])."</td></tr><tr><td></td><td></td></tr></table>";
		$i=$i+1;
		$rtf->parce_html($text);
	}
}
