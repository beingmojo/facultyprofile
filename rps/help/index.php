...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/help_template.dwt.php" codeOutsideHTMLIsLocked="false" -->
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
        <!-- InstanceBeginEditable name="doctitle" -->
        <title>rSp Help Guide - Table of Contents</title>
        <!-- InstanceEndEditable -->
        <link href="../styles/style1.css" rel="stylesheet" type="text/css" />
        <link href="../styles/list.css" rel="stylesheet" type="text/css" />
        <!-- InstanceBeginEditable name="head" -->
        <script src="scripts/ssm.js" language="JavaScript1.2" type="text/javascript"></script>
        <script src="scripts/ssmItems.js" language="JavaScript1.2" type="text/javascript"></script>
        <script src="scripts/image.js" language="javascript" type="text/javascript"></script>
        <style type="text/css">
            <!--
            .style1 {color: #FFFFFF}
    ...
    <body>
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="form_elements_row_action" id="basic_layout">
            <tr>
                <td height="3" class="table_background">
                    <table width="100%"  border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td><div align="left"><img src="../images/txstate-1.jpg" alt="Research Profile" width="751" height="95" align="left" /></div>          </td>
                            <td>
            ...
            <tr>
                <td width='30%' align="left" class="table_background_other">
                    <table width="100%"  border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td><!-- InstanceBeginEditable name="pagename" -->
                                <div align="left" class="page_heading" style="height:auto; width:auto">Help Guide - Table of Contents <span class="style2">(Under Construction)</span>
                                    <!-- InstanceEndEditable -->
                            </td>
                            <td>
                                <div id="menu">
                                    <ul id="nav">
                                        ...
                                        <li><a href="../aboutrsp.php">Support</a>
                                            <ul>
                                                ...
                                                <li><a href="index.php">Help and FAQ's</a></li>
            ...
            <tr>
                <td>
                    ...
                    <div style="padding-left:20px; max-width:95em;">
                        ...
                        <p class="font_orange">
                            <strong>The ReSearch Profile (RSP) system provides: </strong>
                        </p>
                        ...
                        <p class="list_others">
		The  ReSearch Profile system (RSP) is a response to the Texas Industry and  Technology clusters in order 
		to facilitate problem solving,  collaboration, and technology transfer among research experts and  
		organizations in Academia, Industry and Government. The goal of RSP is  to become a synergistic marketplace to 
		...
		new or expand existing markets, provide job growth and develop  wealth.
                        ...
                        <p class="list_others">
		RSP  is a method to transform the culture of Academia to becoming sellers  and marketers of research and ideas. 
		...
		economic growth!</strong>
                        ...
                        <p>
                            <span class="font_orange"><strong>RSP hosts the following profiles:&nbsp;</strong></span>
                        ...
                        <p class="list_others">
		All UTA Employees can login into rSp using their NetID and password. 
		The Login section is located at the bottom-left corner of the Home screen as shown below.
                        ...
                        <p class="list_others" style="float:left; padding-right:10px;">
                            <img src="screenshots/thumbnails/login.png" alt="Login Screenshot" width="100" height="82" border="1" /><br />
                            <a href="screenshots/login.png" onclick="return enlarge('screenshots/login.png',event,'center',402,331)">&nbsp;View Screenshot</a>
                        </p>
                        <p class="list_others">
		...
		If you are not sure what your NetID is, contact helpdesk at 22208 or <a href="mailto:helpdesk@uta.edu?subject=Help with NetID&amp;cc=raweb@uta.edu">helpdesk@uta.edu</a>.
                        </p>
                        <p class="list_others">
		[<a href="https://oit.uta.edu/slfsrv/noauth/resetpw.php">Change your NetID password</a>]&nbsp;&nbsp;
		[<a href="https://eservices.uta.edu/resetpassword/" >Reset Password</a>]&nbsp;&nbsp;
                        </p>
                        <p class="list_others">
		For more information regarding NetID, visit: 
                            <a href="http://oit.uta.edu/cs/accounts/facstaff/netid/netid.html">
		  http://oit.uta.edu/cs/accounts/facstaff/netid/netid.html		</a>	</p>
		...
		in the UTA User directory. 
                        </p>
                        <p class="list_others" style="float:left; padding-right:10px;">
                            <img src="screenshots/thumbnails/account-info.png" alt="Login Screenshot" width="100" height="43" border="1" /><br />
		...
		My Profiles. Details on the Account Information can be changed anytime using the Account 
		Information Link on your <a href="myprofiles.htm">My Profiles</a> page
                        </p>
                        <div style="clear:both"><hr width="100%" class="font_orange" /></div>
                        ...
                        <!-- MY PROFILES -->
                        <div class="table_background">
                            <a name="myprofiles" class="font_topic_other">&nbsp;MY PROFILES</a>
                        </div>
                        <p class="list_others" style="float:left; padding-right:10px;">
                            <img src="screenshots/thumbnails/my-profiles.png" alt="My Profiles Screenshot" width="100" height="58" /><br />
                            <a href="screenshots/my profiles.png" onclick="return enlarge('screenshots/my profiles.png',event,'center',688,396)">&nbsp;View Screenshot</a>
                        </p>
                        <p class="list_others">Profiles in My profiles fall under two broad categories:</p>
	...
	Editors for these profiles can be assigned using the Toolbox.</p>
                        ...
                        <p class="list_others" align="left">
                            <img src="screenshots/thumbnails/profiles.png" alt="create new profile snapshot" width="100" height="59" /><br />
                            <a href="screenshots/profiles.png" onclick="return enlarge('screenshots/profiles.png',event,'center',703,396)">&nbsp;View Screenshot</a>
                        </p>
                        ...
                        <ul style="list-style:none" class="list_others">
                            ...
                            <li>This option will be provided only if your Faculty Profile does not exist - <a href="myprofiles.htm">View My Profiles</a> for more information</li>
                            <li>&nbsp;</li>
		...
		However you may want to check if the profile has already been created by using the search (<img src="../images/buttons/find.gif" alt="find button" />) button.</li>
			...
			hidden is not displayed here. Also only sections with content are visible to the visitor.		</li>
                        ...
                        <ul style="list-style:none" class="list_others">
                            ...
                            <li>This button is used to search for people/equipments/technologies/facilities to add it to a profile.</li>
                            <li>It can also be used to search for existing content in rSp.</li>
                            <li>&nbsp;</li>
                        ...
                        <p class="list_others">Faculty Profile is built to allow UTA faculty to create an individual web page.
	...
	Faculty Profiles also gives an option to include descriptive links to labs or other group web pages along with keywords eliminating the need to create separate profiles for them if not required and yet making them searchable.</p>
                        <p class="list_others" style="float:left; padding-right:10px;">
                            <img src="screenshots/thumbnails/faculty/sample-faculty-profile.png" alt="Sample Faculty Profile" width="100" height="109" /><br />
                            <a href="screenshots/faculty/sample faculty profile.png" onclick="return enlarge('screenshots/faculty/sample faculty profile.png',event,'center',703,767)">&nbsp;View Screenshot</a>
                        </p>
                        ...
                        <p class="list_others" style="float:left; padding-right:10px;">
                            <img src="screenshots/thumbnails/research center/sample-research-center-prof.png" alt="Sample Research Center Profile" width="100" height="110" /><br />
                            <a href="screenshots/research center/sample research center profile.png" onclick="return enlarge('screenshots/research center/sample research center profile.png',event,'center',703,772)">&nbsp;View Screenshot</a>
                        </p>
                        <div style="clear:both"><hr width="100%" class="font_orange" /></div>
                        ...
                        <p class="list_others" style="float:left; padding-right:10px;">
                            <img src="screenshots/thumbnails/technology/sample-technology-profile2.png" alt="Sample Technology Profile" width="100" height="100" /><br />
                            <a href="screenshots/technology/sample technology profile2.png" onclick="return enlarge('screenshots/technology/sample technology profile2.png',event,'center',703,705)">&nbsp;View Screenshot</a>
                        </p>
                        <div style="clear:both"><hr width="100%" class="font_orange" /></div>
                        ...
                        <p class="list_others" style="float:left; padding-right:10px;">
                            <img src="screenshots/thumbnails/facility/sample-facility-profile.png" alt="Sample Facility Profile" width="100" height="94" /><br />
                            <a href="screenshots/facility/sample facility profile.png" onclick="return enlarge('screenshots/facility/sample facility profile.png',event,'center',703,664)">&nbsp;View Screenshot</a>
                        </p>
                        <div style="clear:both"><hr width="100%" class="font_orange" /></div>
-->
                        <!-- EQUIPMENT PROFILE -->
                        ...
                        <p class="list_others" style="float:left; padding-right:10px;">
                            <img src="screenshots/thumbnails/equipment/sample-equipment-profile.png" alt="Sample Equipment Profile" width="100" height="36" /><br />
                            <a href="screenshots/facility/sample facility profile.png" onclick="return enlarge('screenshots/equipment/sample equipment profile.png',event,'center',986,351)">&nbsp;View Screenshot</a>
                        </p>
                        <div style="clear:both"><hr width="100%" class="font_orange" /></div>
...
-->
                        ...
                        <p class="list_others" style="float:left; padding-right:10px;">
                            <img src="screenshots/thumbnails/faculty/contact-info.png" alt="Faculty - Contact Information" width="100" height="16" /><br />
                            <a href="screenshots/faculty/contact%20info.png" onclick="return enlarge('screenshots/faculty/contact%20info.png',event,'center',990,159)">&nbsp;View Screenshot</a>
                        </p>
                        <p class="list_others">The picture below is a screenshot of the edit mode for the Contact Information. </p>
                        <p class="list_others" style="float:left; padding-right:10px;">
                            <img src="screenshots/thumbnails/faculty/contact-info-edit.png" alt="Faculty - Editing Contact Information" width="100" height="24" /><br />
                            <a href="screenshots/faculty/contact%20info%20edit.png" onclick="return enlarge('screenshots/faculty/contact%20info%20edit.png',event,'center',988,237)">&nbsp;View Screenshot</a>
                        </p>
                        ...
                        <p class="list_others" style="float:left; padding-right:10px;">
                            <img src="screenshots/thumbnails/faculty/research-&amp;-expertise-edit.png" alt="Faculty - Research Expertise" width="100" height="36" /><br />
                            <a href="screenshots/faculty/research &amp; expertise edit.png" onclick="return enlarge('screenshots/faculty/research &amp; expertise edit.png',event,'center',813,290)">&nbsp;View Screenshot</a>	</p>
                        <div style="clear:both"><hr width="100%" class="font_orange" /></div>
                        ...
                        <p class="list_others" style="float:left; padding-right:10px;">
                            <img src="screenshots/thumbnails/faculty/appiontments-edit.png" alt="Faculty - Appointments" width="100" height="22" /><br />
                            <a href="screenshots/faculty/appiontments edit.png" onclick="return enlarge('screenshots/faculty/appiontments edit.png',event,'center',813,178)">&nbsp;View Screenshot</a>	</p>
                        <div style="clear:both"><hr width="100%" class="font_orange" /></div>
                        ...
                        <p class="list_others" style="float:left; padding-right:10px;">
                            <img src="screenshots/thumbnails/faculty/publication-edit.png" alt="Faculty - Publications" width="100" height="57" /><br />
                            <a href="screenshots/faculty/publication edit.png" onclick="return enlarge('screenshots/faculty/publication edit.png',event,'center',810,465)">&nbsp;View Screenshot</a>	</p>
                        <div style="clear:both"><hr width="100%" class="font_orange" /></div>
                        ...
                        <p class="list_others" ><img src="screenshots/faculty/presentations & projects.png" alt="Login Screenshot" width="813" height="108" /></p>
                        <p class="list_others" ><img src="screenshots/faculty/presentations & projects edit.png" alt="Login Screenshot" width="812" height="373" /></p>
                        <div style="clear:both"><hr width="100%" class="font_orange" /></div>
                        ...
                        <p class="list_others" style="float:left; padding-right:10px;">
                            <img src="screenshots/thumbnails/faculty/teaching.png" alt="Faculty - Teaching" width="100" height="135" /><br />
                            <a href="screenshots/faculty/teaching.png" onclick="return enlarge('screenshots/faculty/teaching.png',event,'center',961,1298)">&nbsp;View Screenshot</a>	</p>
                        <div style="clear:both"><hr width="100%" class="font_orange" /></div>
                        ...
                        <p class="list_others">Add any news relevant to your profile. Also any news published on UTA websites/magazines would be automatically provided as a link &quot;Read Other Online News Articles&quot;. </p>
                        <p class="list_others" ><img src="screenshots/faculty/news & articles.png" alt="Login Screenshot" width="814" height="121" /></p>
                        <p class="list_others"><img src="screenshots/faculty/news & articles add.png" alt="Login Screenshot" width="813" height="308" /></p>
                        <div style="clear:both"><hr width="100%" class="font_orange" /></div>
                        ...
                        <p class="list_others" ><img src="screenshots/faculty/affiliations.png" alt="Login Screenshot" width="814" height="134" /></p>
                        <p class="list_others" ><img src="screenshots/faculty/affiliations%20edit.png" alt="Login Screenshot" width="812" height="329" /></p>
                        <div style="clear:both"><hr width="100%" class="font_orange" /></div>
                        ...
                        <p class="list_others" ><img src="screenshots/faculty/support.png" alt="Login Screenshot" width="815" height="132" /></p>
                        <p class="list_others" ><img src="screenshots/faculty/support%20edit.png" alt="Login Screenshot" width="814" height="184" /></p>
                        <div style="clear:both"><hr width="100%" class="font_orange" /></div>
                        ...
                        <p class="list_others" ><img src="screenshots/faculty/additional%20info.png" alt="Login Screenshot" width="815" height="80" /></p>
                        <p class="list_others">&nbsp;</p>
                        <div style="clear:both"><hr width="100%" class="font_orange" /></div>
                        ...
                        <p class="list_others"><img src="screenshots/research center/about.png" alt="Login Screenshot" width="982" height="171" /></p>
                        <p class="list_others"><img src="screenshots/research center/about edit.png" alt="Login Screenshot" width="986" height="233" /></p>
                        <p class="list_others">&nbsp;</p>
                        <div style="clear:both"><hr width="100%" class="font_orange" /></div>
                        ...
                        <p class="list_others" ><img src="screenshots/research center/research &amp; service.png" alt="Login Screenshot" width="813" height="283" /></p>
                        <p class="list_others" ><img src="screenshots/research center/research &amp; service edit.png" alt="Login Screenshot" width="813" height="434" /></p>
                        <div style="clear:both"><hr width="100%" class="font_orange" /></div>
                        ...
                        <p class="list_others"><img src="screenshots/research center/publications.png" alt="Login Screenshot" width="813" height="190" /></p>
                        <p class="list_others" ><img src="screenshots/faculty/publication%20edit.png" alt="Login Screenshot" width="810" height="465" /></p>
                        <div style="clear:both"><hr width="100%" class="font_orange" /></div>
