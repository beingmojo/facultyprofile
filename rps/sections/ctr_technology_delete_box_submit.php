...
if( real_can_user_edit( $db_conn, $pid ) == true )
{
	...
	{
		$query = 	"DELETE FROM gen_association USING gen_association, ctr_technology
						WHERE gen_association.pid = ctr_technology.tech_pid 
						AND gen_association.assoc_pid = ctr_technology.pid 
						AND ctr_technology.add_req = 0 
						AND ctr_technology.pid = " . real_mysql_specialchars( $pid, true );
