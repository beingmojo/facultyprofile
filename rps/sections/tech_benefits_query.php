<?php
	$tech_benefits_query = "SELECT * FROM tech_benefits WHERE pid = " . real_mysql_specialchars( $pid, true ) ;
	$tech_benefits_results = real_execute_query ( $tech_benefits_query, $db_conn );
/*
	if( $editable == true )
	{
