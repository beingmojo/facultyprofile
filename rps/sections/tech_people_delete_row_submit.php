...
if( real_can_user_edit( $db_conn, $pid ) == true )
{
	...
	$query = 	"DELETE FROM gen_association USING gen_association, tech_people 
					WHERE gen_association.assoc_login_id = tech_people.ppl_login_id 
					AND gen_association.pid = tech_people.pid 
					AND tech_people.ppl_id = " . real_mysql_specialchars( $pp_id, true ) . 
				"	AND tech_people.pid  = " . real_mysql_specialchars( $pid, true );
	real_execute_query( $query, $db_conn );
	
	$query = "DELETE FROM tech_people " .
