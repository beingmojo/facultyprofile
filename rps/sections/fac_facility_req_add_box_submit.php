...
if( real_can_user_edit( $db_conn, $pid ) == true )
{
	...
	{
		$query = "INSERT IGNORE INTO gen_association (pid, assoc_pid) SELECT fac_pid, pid FROM fac_facility WHERE add_req = 1 AND pid = " . real_mysql_specialchars( $pid, true );
		real_execute_query( $query, $db_conn );

		$query = "UPDATE fac_facility SET del_req = 0, add_req = 0 " .
