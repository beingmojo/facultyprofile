		...
		print( "<table width='100%'  border='0' cellspacing='0' cellpadding='0' >" );
			print( "<tr class='table_background'>" );
				...
				if( $editable == true )
				{
					...
					print( "<a href='#' style='text-decoration:none' onclick='return edit_box( \"ppl_general_info\" )'><img alt='edit' border='0' src='images/buttons/edit.gif'  > <span class='form_elements_section_action'>Edit &nbsp;</span></a>" );
				}
				print( "</td>" );
			print( "</tr>" );
			print( "<tr>" );
			...
			print( "<tr >" );
				print( "<td colspan='2'>" );
				if ( $generalrows[ "status_address" ] == 0)
					print( "<span class='form_elements_text'>" );
				else
					print( "<span class='form_elements_text_disabled'>" );
				if( $editable == true || $generalrows[ "status_address" ] == 0)
				{
					...
					if( $address != "" )
						print( "<img src='images/icons/address.png' width='12' height='12' border='0' alt='Contact address' /> &nbsp; $address &nbsp;&nbsp;&nbsp;&nbsp;");
				}
				print( "</span>" );
				if ( $generalrows[ "status_mail_address" ] == 0)
					print( "<span class='form_elements_text'>" );
				else
					print( "<span class='form_elements_text_disabled'>" );
			...
			print( "<tr >" );
				print( "<td colspan='2'>" );
				if( $generalrows[ "status_email_id" ] == 0 )
					print( "<span class='form_elements_text'>" );
				else
					print( "<span class='form_elements_text_disabled'>" );
				if( $editable == true || $generalrows[ "status_email_id" ] == 0)
				{
					if ( $generalrows[ "email_id" ] != "" )
				...
				if( $generalrows[ "status_phone_no_1" ] == 0 )
					print( "<span class='form_elements_text'>" );
				else
					print( "<span class='form_elements_text_disabled'>" );
				if( $editable == true || $generalrows[ "status_phone_no_1" ] == 0)
				{
					if( $generalrows[ "phone_no_1" ] != "" )
				...
				if( $editable == true || $generalrows[ "status_cell_no" ] == 0)
				{
					...
					if ( $generalrows[ "cell_no" ] != "" )
						echo "<img src='images/icons/cell.png' width='12' height='12' border='0' alt='Cell Phone' />" .
